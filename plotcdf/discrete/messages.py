...
# Support shape and cardinality validation messages.
...
# Probability content and compatibility validation messages.
...
# Tolerance and tail-completeness validation messages.
...
# Input-format mode validation message.
